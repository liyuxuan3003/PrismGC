...
// -----------------------------------------------------------------------------
  ...
  // Input stage for SI0
  BuzzerSoCBusIn u_BuzzerSoCBusIn_0 (
  ...
  // Input stage for SI1
  BuzzerSoCBusIn u_BuzzerSoCBusIn_1 (
  ...
  // Input stage for SI2
  BuzzerSoCBusIn u_BuzzerSoCBusIn_2 (
  ...
  BuzzerSoCBusDecS0 u_buzzersocbusdecs0 (
  ...
  BuzzerSoCBusDecS1 u_buzzersocbusdecs1 (
  ...
  BuzzerSoCBusDecS2 u_buzzersocbusdecs2 (
  ...
  BuzzerSoCBusOut u_buzzersocbusout_0 (
  ...
  BuzzerSoCBusOut u_buzzersocbusout_1 (
  ...
  BuzzerSoCBusOut u_buzzersocbusout_2 (
