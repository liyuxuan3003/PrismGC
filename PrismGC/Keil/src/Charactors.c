...
void MainCharactor (uint32_t x,uint32_t y)
{
    ...
    uint32_t l6[17]={BLACK,LIGHTBLUE,BLUE,BLUE,BLACK,BLUE,BLUE,BLUE,BLUE,BLUE,BLUE,BLUE,BLACK,BLUE,BLUE,LIGHTBLUE,BLACK};
    uint32_t l7[17]={BLACK,BLUE,BLUE,BLUE,BLACK,BLUE,BLUE,BLUE,BLUE,BLUE,BLUE,BLUE,BLACK,BLUE,BLUE,BLUE,BLACK};
    uint32_t l8[17]={BLACK,BLUE,BLUE,BLUE,DARKBLUE,BLUE,BLUE,BLUE,BLUE,BLUE,BLUE,BLUE,DARKBLUE,BLUE,BLUE,BLUE,BLACK};
    uint32_t l9[17]={BLACK,DARKBLUE,DARKBLUE,BLUE,BLUE,BLUE,BLUE,BLUE,BLUE,BLUE,BLUE,BLUE,BLUE,BLUE,BLUE,DARKBLUE,BLACK};
    ...
    LCDPixels(l6,x-8,y+3,17);
    LCDPixels(l7,x-8,y+4,17);
    LCDPixels(l8,x-8,y+5,17);
    LCDPixels(l9,x-8,y+6,17);
    LCDPixels(l10,x-7,y+7,15);
    LCDPixels(l11,x-5,y+8,11);
...
// LCDPixels(const uint32_t *colors,uint32_t x,uint32_t y,uint32_t len);